...
<%
	...
	while (rs.next()) {
        ...
        strHtmls.append("<td style=' text-align:left;'>" + rs.getString("UserName") + "</td>");
        strHtmls.append("<td style=' text-align:left;'>" + rs.getString("DeptName") + "</td>");
		
         strHtmls.append("<td style=' text-align:left;'>" + rs.getString("SalTotal") + "</td>");
		strHtmls.append("<td style=' text-align:left;'>" + rs.getString("SalDeduct") + "</td>");
		strHtmls.append("<td style=' text-align:left;'>" + rs.getString("SalCount") + "</td>");
